...
obj.question[2].addEventListener('mouseover', () => {
    obj.textDescription[0].innerHTML = '<strong style="color:yellow;">Документы необходимые для оформления свидетельства о государственной регистрации продукции</strong><br><strong style="color:yellow;">При оформлении на отечественного производителя:</strong><li>реквизиты фирмы заявителя</li><li>регистрационные документы (ИНН, ОГРН, коды статистики)</li><li>ГОСТ или ТУ (технические условия), по которому производится продукция</li><li>договор аренды производственных площадей или свидетельство о собственности</li><li>проекция этикетки (по возможности)</li><strong style="color:yellow;">При оформлении на импортного производителя:</strong><li>Заявка</li><li>Техническое описание продукции</li><li>Проект этикетки</li><strong style="color:yellow;">На химическую продукцию дополнительно предоставляются:</strong><li>Паспорт безопасности MSDS с переводом на рус. яз.</li><li>Лист технических данных TDS с переводом на рус. яз.</li><li>Инструкция по применению</li>'
})
...
obj.question[3].addEventListener('mouseover', () => {
    obj.textDescription[0].innerHTML = '<strong style="color:yellow;">Что такое СГР (Свидетельство о гос. регистрации)</strong><br>Государственная регистрация продукции на требования безопасности Таможенного союза, является необходимым условием для перемещения товаров, подлежащих санитарно-эпидемиологическому надзору (контролю) на таможенной границе и таможенной территории ТС.<br><strong style="color:yellow;">Государственная регистрация продукции</strong> — единственный и необходимый способ для того, чтобы официально зарегистрировать производимый товар на территории Таможенного союза. Только получив свидетельство ЕВРАЗЭС, Вы сможете легально производить, хранить, перевозить, продавать изделия. Оформление свидетельства занимает значительный промежуток времени, даже при условии, что собраны все требуемые бумаги. Это связано с необходимостью тщательной проверки соответствия продукции всем предъявляемым по законодательству страны гигиеническим и санитарным нормам. Только после полной проверки, если нареканий не найдено, продукцию вносят в госреестр, и затем выдается <strong style="color:yellow;">свидетельство о государственной регистрации продукции.</strong>'
})
